...
for i in range(env.horizon):
 ...
 projection=cs.solve_cbvf_projection_exact(s,t,_reference_warmup_action(s,.8,world.goal,(-.9,.65)),table,env,1.5,rhs)
 ...
 if done:break
out=root/'results_intersample_v5/cp_outward_waypoint_diagnosis';out.mkdir(exist_ok=False)
